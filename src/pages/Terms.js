...
const list = [
  {
    term: "apR",
    mean: "Refers to the simple returns in USD value relative to your staked XPANZ or TYSHARE. ",
  },
  {
    term: "apy",
  ...
  {
    term: "THE farm",
    mean: "The Farm is the DeFi App, where you stake your XPANZ Token or LPs (Liquidity Pool tokens).",
  },
  {
