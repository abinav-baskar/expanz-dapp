    ...
    <section className="liquidity py-20 text-white">
      <div className="px-10 sm:container">
        <div className="custom-container md:px-10">
          ...
          >
            XPANZ Auto-Liquidity _ v1 (TAL1)
          </h2>
          <p
            data-aos="fade-up"
            className="font-bold leading-relaxed text-base sm:text-lg mt-10"
          >
            Every 48 hours at 22:52:48 UTC time our XPANZ Auto-Liquidity Engine
            ...
            is the mechanism which smartly takes the 50% of the amount of XPANZ
            stored in the wallet, and will automatically buy BNB at the current
            market price.
            <br />
            <br />
            The remaining 50% of XPANZ in the Auto-LP wallet will be used for
            the XPANZ side of liquidity, therefore giving equal an 50/50
            weighting of XPANZ/BNB which will then be automatically added as
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-8">
            ...
            >
              ...
              liquidity to the pool which will allow $XPANZ token holders to
              ...
              make sure the APY is upheld for the entire life of XPANZ.
            </p>
