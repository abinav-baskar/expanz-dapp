...
const scanXPANZ = config.BlockExplorerURL[config.chainID] + "/address/" + config.XPANZ[config.chainID];
          ...
          >
            <a
              ...
              <p className="uppercase text-primary text-center  mb-6 font-bold text-xl break-words">
                <span className="text-white">XPANZ Contract:</span>{" "}
                <span className=" underline text-sm md:text-xl font-bold">
                  {config.XPANZ[config.chainID]}
                </span>
              </p>
            </a>
          </div>
